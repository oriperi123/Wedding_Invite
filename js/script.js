...
var countDownDate = new Date("November 12, 2021 00:00:00").getTime();
...
var x = setInterval(function() {
    ...
    if (distance < 0) {
        clearInterval(x);
        document.getElementById("time").innerHTML = '<font size=1.5>הכניסה עם שורש/טבע/כפכפים אסורה ע״פ הנחיות משרד הבריאות</font>';
    }
}, 1000);
...
console.log('\n\n%c SAVE THE DATE: 16th July, 2021!', styles);

console.log('%cYour presence is requested!%c\n\nRegards:Danielle and Guy', styles1, styles2);
